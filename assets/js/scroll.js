...
// h2.html
const scrollBtns1 = document.querySelectorAll("#smbtn1");
const singleSlider1 = document.querySelector(".scroll1");

scrollBtns1.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    const value = e.currentTarget.dataset.id;
    singleSlider1.innerHTML = `<div><img class="img-responsive center-block" src="../img/products/pouf/ME-P-${value}.png" alt="slider"></div>`;
    count = value;
    carousel1();
  });
});

const slideBtns1 = document.querySelectorAll(".npbtn1");

slideBtns1.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    const styles = e.currentTarget.classList;
    if (styles.contains("next-slide")) {
      count++;
      if (count < 10) {
        singleSlider1.innerHTML = `<div><img class="img-responsive center-block" src="../img/products/pouf/ME-P-00${count}.png" alt="slider"></div>`;
      } else {
        singleSlider1.innerHTML = `<div><img class="img-responsive center-block" src="../img/products/pouf/ME-P-0${count}.png" alt="slider"></div>`;
      }
...
const singleSlider = document.querySelector(".scroll");
let imageUrl = "";
...
scrollBtns.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    ...
    singleSlider.innerHTML = `<div><img class="img-responsive center-block" src=${url} alt="slider"></div>`;
    count = id;
    imageUrl = url;
    carousel();
  });
...
slideBtns.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    ...
    if (styles.contains("next-slide")) {
      ...
      count++;
      if (count < 10) {
        singleSlider.innerHTML = `<div><img class="img-responsive center-block" src=${imageUrl} alt="slider"></div>`;
      } else {
        singleSlider.innerHTML = `<div><img class="img-responsive center-block" src=${imageUrl} alt="slider"></div>`;
      }
    } else if (styles.contains("prev-slide")) {
